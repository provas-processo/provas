    ...
    return (
      <div className="min-h-[100dvh] bg-slate-950 flex items-center justify-center p-4">
        <form onSubmit={handleLogin} className="bg-slate-900 p-8 rounded-3xl shadow-2xl border border-slate-800 max-w-sm w-full text-center">
          ...
          <input type="text" autoCapitalize="none" autoCorrect="off" spellCheck="false" autoFocus style={{ WebkitTextSecurity: 'disc' }} className="w-full bg-slate-800 text-white p-4 rounded-xl mb-4 outline-none focus:ring-2 focus:ring-blue-500 font-bold text-center" placeholder="SENHA" value={passwordInput} onChange={(e) => setPasswordInput(e.target.value)} />
